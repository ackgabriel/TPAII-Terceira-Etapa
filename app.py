...
LAYOUT_BASE = dict(
    ...
    xaxis=dict(showgrid=True, gridcolor="#EEF2F7", gridwidth=1,
...
with aba1:
    ...
    with col_tab:
        ...
        tabela["C. Cidade"]  = tabela["C. Cidade"].round(2)
        tabela["C. Estrada"] = tabela["C. Estrada"].round(2)
        ...
        st.dataframe(tabela.style.map(colorir, subset=["Combustível"]),
...
with aba2:
    ...
    fig_bar.update_layout(
        **LAYOUT_BASE,
        ...
        xaxis=dict(range=[0, top5["consumo_medio"].max() * 1.22],
    ...
    fig_scatter = px.scatter(
        ...
        hover_name="modelo",
        hover_data={
            "consumo_medio":   (":.2f km/L", df_f["consumo_medio"]),
            "custo_beneficio": (":.1f",       df_f["custo_beneficio"]),
            "preco":           (":,.0f",      df_f["preco"]),
            "combustivel": True,
        },
    ...
    fig_scatter.update_layout(
        **LAYOUT_BASE,
        xaxis=dict(showgrid=True, gridcolor="#EEF2F7", title="CM (km/L)"),
        yaxis=dict(showgrid=True, gridcolor="#EEF2F7", title="CB (índice)"),
